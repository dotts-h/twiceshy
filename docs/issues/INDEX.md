...
| [0101](0101-epic-fleet-wide-enforcement-adapters-adr-0026-o3-capture-inject-across-gemini-cli-ask-codex-ask-cursor-wrappers-and-the-non-agentic-gateway-floor.md) | Epic: Fleet-wide enforcement adapters (ADR-0026 O3) — capture & inject across Gemini CLI, ask-codex/ask-cursor wrappers, and the non-agentic gateway floor | open | medium | — | |
| [0102](0102-gemini-cli-sessionend-shipper-post-retro-on-session-end-mirror-the-claude-code-hook.md) | Gemini CLI SessionEnd shipper — POST /retro on session end (mirror the Claude Code hook) | open | medium | 0101 | |
| [0103](0103-wrapper-session-end-shippers-for-ask-codex-and-ask-cursor-stop-finally-post-retro.md) | Wrapper session-end shippers for ask-codex and ask-cursor (Stop/finally → POST /retro) | open | medium | 0101 | |
| [0104](0104-gateway-floor-for-non-agentic-executors-code-exec-injects-pre-call-and-emits-a-session-end-record-on-close.md) | Gateway floor for non-agentic executors — code-exec injects pre-call and emits a session-end record on close | open | medium | 0101 | |
