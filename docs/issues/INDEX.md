...
| [0137](0137-tenant-registry-is-not-derived-state-rebuild-preservation-test-contract-wording-runbook-backup-note-adr-0034-phase-1.md) | Tenant registry is not derived state — Rebuild-preservation test, contract wording, runbook backup note (ADR-0034 phase 1) | open | medium | 0124 | |
