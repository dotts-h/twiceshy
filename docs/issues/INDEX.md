...
| [0135](0135-atomic-fail-closed-contribution-quota-debit-decouple-write-path-quota-enforcement-from-best-effort-tenant-telemetry.md) | Atomic fail-closed contribution-quota debit — decouple write-path quota enforcement from best-effort tenant telemetry | open | high | 0124 | |
