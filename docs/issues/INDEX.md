...
| [0133](0133-external-oss-git-trap-miner-mine-fix-shaped-commits-from-permissively-licensed-high-star-repos-react-rn-swift-kotlin-coverage.md) | External-OSS git trap miner — mine fix-shaped commits from permissively-licensed high-star repos (React/RN/Swift/Kotlin coverage) | open | medium | 0088 | |
| [0134](0134-wtfjs-wtfpython-importer-wtfpl-curated-gotcha-collections-as-quarantined-experience-records.md) | wtfjs/wtfpython importer — WTFPL curated gotcha collections as quarantined experience records | open | low | 0088 | |
