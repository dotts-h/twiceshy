...
| [0013](ADR-0013-closed-loop-autonomous-validation.md) | Closed-loop autonomous validation — proof + a diverse-model judge replace the human approver for provable records | Proposed |
