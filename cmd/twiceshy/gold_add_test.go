...
// TestGoldAddAdvisory_RegenerationMatchesCommitted needs the live corpus (the 85
// advisory records the audit references), now decoupled into twiceshy-corpus
// (ADR-0021), so it moved to gold_add_livecorpus_test.go behind the livecorpus tag.
