...
func TestPromoteCorpus_EmitsStructuredLog(t *testing.T) {
	...
	_, err := promoteCorpus(context.Background(), ".", recs, fp, persist, guard.Guardrails{}, logger, &bytes.Buffer{})
	if err != nil {
...
func TestAdaptCorpus_LogsHeldOutcome(t *testing.T) {
	...
	st, err := adaptCorpus(context.Background(), ".", recs, runner, adapter, persist, guard.Guardrails{}, logger, &bytes.Buffer{})
	if err != nil {
